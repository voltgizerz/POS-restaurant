...
// Source: ./internal/core/ports/menu_ports.go
//
...
func (m *MockIMenuRepository) UpdateActiveMenuBatchUser(ctx context.Context, tx *sql.Tx, userID int64) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateActiveMenuBatchUser", ctx, tx, userID)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockIMenuRepositoryMockRecorder) UpdateActiveMenuBatchUser(ctx, tx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateActiveMenuBatchUser", reflect.TypeOf((*MockIMenuRepository)(nil).UpdateActiveMenuBatchUser), ctx, tx, userID)
}

// UpdateActiveMenuByMenuID mocks base method.
func (m *MockIMenuRepository) UpdateActiveMenuByMenuID(ctx context.Context, tx *sql.Tx, menuID int64) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateActiveMenuByMenuID", ctx, tx, menuID)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// UpdateActiveMenuByMenuID indicates an expected call of UpdateActiveMenuByMenuID.
func (mr *MockIMenuRepositoryMockRecorder) UpdateActiveMenuByMenuID(ctx, tx, menuID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateActiveMenuByMenuID", reflect.TypeOf((*MockIMenuRepository)(nil).UpdateActiveMenuByMenuID), ctx, tx, menuID)
}
...
// UpdateMenuByMenuID indicates an expected call of UpdateMenuByMenuID.
func (mr *MockIMenuRepositoryMockRecorder) UpdateMenuByMenuID(ctx, tx, menuData any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateMenuByMenuID", reflect.TypeOf((*MockIMenuRepository)(nil).UpdateMenuByMenuID), ctx, tx, menuData)
}
