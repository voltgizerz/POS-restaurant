...
// Source: ./internal/adapters/ports/menu_ports.go
//
// Generated by this command:
//
//	mockgen -source=./internal/adapters/ports/menu_ports.go -destination=./internal/mocks/mocks_menu.go -package=mocks
//
